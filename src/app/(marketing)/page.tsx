        ...
        <div style={{ display:"flex", justifyContent:"space-between", flexWrap:"wrap", gap:16 }}>
          ...
          <div style={{ display:"flex", flexDirection: "column", gap:16, alignItems: "flex-end" }}>
            <div style={{ display:"flex", gap:16, alignItems: "center" }}>
              <Link href="https://twitter.com/labvex" target="_blank" style={{ color: "var(--subtle)" }} onMouseEnter={e=>(e.currentTarget.style.color="var(--ink)")} onMouseLeave={e=>(e.currentTarget.style.color="var(--subtle)")}>
              ...
              <Link href="https://github.com/labvex" target="_blank" style={{ color: "var(--subtle)" }} onMouseEnter={e=>(e.currentTarget.style.color="var(--ink)")} onMouseLeave={e=>(e.currentTarget.style.color="var(--subtle)")}>
